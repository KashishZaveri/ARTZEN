...
export async function createOrder(amount) {
  try {
    ...
    const response = await fetch("https://artzen-backend.onrender.com/api/payment/create-order", {
      method: "POST",
      headers: {
...
export async function sendBillEmail(details) {
  try {
    const response = await fetch("https://artzen-backend.onrender.com/api/payment/send-bill-email", {
      method: "POST",
